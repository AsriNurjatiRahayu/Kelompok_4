...
News hotesNews = News(
  id: 'hotes-001',
  date: '08-04-2023',
  imageUrl: 'https://i.postimg.cc/NFBxBshP/059557800-1626167508-sergio-capuzzimati-SITw-DBhar6w-unsplash.jpg',
  title:
      '10 Jenis Ikan Koi Paling Populer dan Keunikannya',
  content:
...
List<News> latesNews = [
  News(
    ...
    date: '02-14-2023',
    imageUrl:
        'https://i.postimg.cc/qvh2fhhv/088737400-1664962686-page.jpg',
    title:
  ...
  News(
    ...
    title:
        'BERANI BERUBAH: Dari Hobi, Kini Jadi Hoki dari Ikan Koi',
    content:
  ...
  News(
    id: 'lates-004',
    date: '02-25-2023',
    imageUrl: 'https://i.postimg.cc/P5YHBsD9/085421800-1641371010-page.jpg',
    title: 'Pria Ini Rela Jual Tanah Demi Beli Seekor Ikan Koi Seharga Rp 1 Miliar',
    content:
        'Salah satu hobi yang banyak digemari di Indonesia adalah memelihara ikan hias. Tak sedikit orang meluangkan waktunya untuk memelihara ikan hias di akuarium maupun kolam. Bahkan beberapa di antaranya sampai rela merogoh kocek dalam, demi memenuhi kesenangannya tersebut. Ada pula orang yang rela menjual asetnya untuk membeli ikan yang diinginkan dan menganggapnya sebagai investasi. Seperti yang dilakukan oleh pria di Malaysia yang baru-baru ini viral di media sosial. Pria bernama Mohd Zulkifli Husin itu diketahui rela menjual tanah untuk membeli seekor ikan koi.',
  ),
  News(
    id: 'lates-005',
    date: '02-25-2023',
